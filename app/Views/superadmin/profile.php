    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5><i class="fas fa-user-shield"></i> Profil Superadmin</h5>
            </div>
            <div class="card-body">
                <form id="profileForm">
                    <div class="row">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <div class="row text-center">
                    ...
                    <div class="col-6">
                        <div class="stat-number text-success"><?= $stats['active_users'] ?? 0 ?></div>
                ...
                <div class="row text-center">
                    <div class="col-6">
                        <div class="stat-number text-warning"><?= $stats['total_applications'] ?? 0 ?></div>
                        <small class="text-muted">Aplikasi</small>
                    </div>
                    <div class="col-6">
                        <div class="stat-number text-info"><?= $stats['total_complaints'] ?? 0 ?></div>
...
<script>
    document.getElementById('profileForm').addEventListener('submit', function(e) {
        ...
        fetch('<?= base_url('superadmin/profile/update') ?>', {
                method: 'POST',
                body: formData,
                headers: {
