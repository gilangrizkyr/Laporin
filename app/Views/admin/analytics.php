...
<div class="row mb-4">
    <div class="col-md-6 mb-3">
        <div class="card">
            <div class="card-header"><h6 class="mb-0"><i class="fas fa-bug"></i> Top Problematic Applications</h6></div>
            <div class="card-body">
                <?php if (!empty($topApps)): ?>
                    <div class="table-responsive">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                <?php $i = 1; foreach ($topApps as $app): ?>
                                    <tr>
                                        <td><?= $i++ ?></td>
                                        <td><?= esc($app['name']) ?></td>
    ...
    <div class="col-md-6 mb-3">
        <div class="card">
            <div class="card-header"><h6 class="mb-0"><i class="fas fa-user-tie"></i> Admin Performance</h6></div>
            <div class="card-body">
    ...
    <script>
        (function(){
            ...
            const chartAvg = new Chart(avgCtx, {
                type: 'bar',
                data: { labels: labels, datasets: [{ label: 'Avg Resolution (hrs)', data: [], backgroundColor: 'rgba(75, 192, 192, 0.6)' }] },
                options: { responsive: true }
            });
            ...
            new Chart(pctx, {
                ...
                data: {
                    labels: pLabels,
                    datasets: [{ data: priorities, backgroundColor: pColors }]
                },
                options: { responsive: true }
            });
            ...
            function renderAppChart(rows) {
                ...
                new Chart(canvas.getContext('2d'), {
                    type: 'bar',
                    data: { labels: appLabels, datasets: [{ label: 'Complaints', data: appData, backgroundColor: 'rgba(255,99,132,0.6)' }] },
